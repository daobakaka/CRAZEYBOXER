...
public class Actormoveplayer : Player
{
    Rigidbody rb;
    float s, h, y0, x0, tc;
    [SerializeField]
    ...
    void Start()
    {
        ...
        if (IsOwner && IsClient)
        {
            ...
            transform.GetChild(0).GetChild(10).GetChild(0).gameObject.SetActive(true);
            CinemachineFree = transform.GetChild(0).GetChild(10).GetChild(0).GetComponent<CinemachineFreeLook>();
        ...
        animator0 = transform.GetChild(0).GetComponent<Animator>();
        networkAnimator0 = transform.GetChild(0).GetComponent<NetworkAnimator>();
        ...
        soundplayer = transform.GetChild(0).GetChild(13).GetChild(1).GetComponent<AudioSource>();
        soundplayerstep = transform.GetChild(0).GetChild(13).GetChild(0).GetComponent<AudioSource>();
        soundplayerstep.clip = remotebulid0.Music0["step"];
        soundpain = transform.GetChild(0).GetChild(13).GetChild(2).GetComponent<AudioSource>();
        //声音模块
    ...
    {
        actor0 = new Actor();
        sliderhealth = transform.GetChild(0).GetChild(12).GetChild(0).GetComponent<Slider>();
        sliderbackground = transform.GetChild(0).GetChild(12).GetChild(1).GetComponent<Slider>();//获取角色生命值控制条
        sliderstamina = transform.GetChild(0).GetChild(12).GetChild(2).GetComponent<Slider>();//获取角色体力控制条
        staminabackground = transform.GetChild(0).GetChild(12).GetChild(3).GetComponent<Slider>();
        actor0.Insme();
        speed = actor0.speed;
    ...
    IEnumerator HealthmonitorIE()
    {
        ...
        transform.GetChild(0).GetChild(10).GetChild(0).gameObject.SetActive(false);//关闭相机
...
#else
{
 ...
 Monvspmoblie();
    ...
    void ChangeHitname()
    {
        this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(5).gameObject.name = netID.ToString();
        this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(0).GetChild(5).gameObject.name = netID.ToString();
        this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(1).gameObject.name = netID.ToString();
        this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(1).GetChild(0).GetChild(0).GetChild(1).gameObject.name = netID.ToString();
    ...
    public void Hitsports(int pos)//运动函数动画函数
    {
        ...
        {
            case 0://左手、右手、左脚、右脚
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(5).gameObject.SetActive(true);
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(0).GetChild(5).gameObject.SetActive(true);
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(1).gameObject.SetActive(true);
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(1).GetChild(0).GetChild(0).GetChild(1).gameObject.SetActive(true);
                break;
            case 1:
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(1).GetChild(0).GetChild(0).GetChild(1).gameObject.SetActive(true);
                break;
    ...
    public void Hitsports(int pos, string boolstring)//自用动画函数
    {
        ...
        {
            case 0://左手、右手、左脚、右脚
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(5).gameObject.SetActive(bool0);
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(0).GetChild(5).gameObject.SetActive(bool0);
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(1).gameObject.SetActive(bool0);
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(1).GetChild(0).GetChild(0).GetChild(1).gameObject.SetActive(bool0);
                break;
            case 1:
                this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(1).GetChild(0).GetChild(0).GetChild(1).gameObject.SetActive(bool0);
                break;
    ...
    public void Playerskillstart()
    {
        if (IsOwner && IsClient)
        {
            ...
            BroadcastexpServerRpc(this.transform.GetChild(0).GetChild(9).GetChild(0).GetChild(2).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(0).GetChild(5).position, "Skillball", this.name);//右手位置
    ...
    void Monvsp()
    {
        if (IsClient && IsOwner)
        {
            if (attackble)//攻击期间无法使用其他动作
            {
                ...
                if (s >= 0)
                {
                    transform.parent.Translate(0, 0, s * speed * Time.deltaTime, Space.Self);
    ...
    void Movenew()
    {
        if (IsClient && IsOwner)
        {
            ...
            {
                RaycastHit hit;
                transform.Translate(joystick1.Horizontal * speed * Time.deltaTime, 0, joystick1.Vertical * speed * Time.deltaTime);
    ...
    private void Rayfalldown()
    {
        ...
        if (IsOwner && IsClient)
        {
            if (Physics.Raycast(transform.position, -Vector3.up, out hit, 0.05f) || Physics.Raycast(transform.GetChild(0).GetChild(11).position, transform.GetChild(0).GetChild(11).transform.forward, out hit0, 2f))
            {
                Debug.DrawRay(transform.position, Vector3.down, Color.red);
                Debug.DrawRay(transform.GetChild(0).GetChild(11).position, transform.GetChild(0).GetChild(11).transform.forward, Color.blue);
